<?php
namespace TYPO3\SingleSignOn\Server\Security\RequestPattern;
 ...
 *
 */
class SsoClientPublicKeyResolver implements \TYPO3\SingleSignOn\Client\Security\PublicKeyResolverInterface {
